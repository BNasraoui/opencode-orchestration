---
description: Research codebase with parallel analysis
permissions:
  edit: deny
  bash: deny
---
...
9. **Handle follow-up questions:**
   ...
   - Update frontmatter fields `last_updated` and `last_updated_by` to reflect the update
...
- The documentation provides historical context to supplement live findings
...
- Explore all documentation directories, not just research subdirectory
...
- [ ] Architectural insights are valuable and accurate